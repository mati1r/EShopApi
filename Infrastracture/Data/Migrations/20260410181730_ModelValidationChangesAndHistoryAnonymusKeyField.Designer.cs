...
namespace ApiTemplate.Migrations
{
    ...
    [Migration("20260410181730_ModelValidationChangesAndHistoryAnonymusKeyField")]
    partial class ModelValidationChangesAndHistoryAnonymusKeyField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.EShop.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.History", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AnonymusUserAccessKey")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Core.Models.EShop.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductDescriptions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductElement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductPhotos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductRefHistory", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.Subcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EShop.History", b =>
                {
                    b.HasOne("Core.Models.EShop.Address", "Address")
                        .WithMany("Histories")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.EShop.PaymentType", "PaymentType")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("Core.Models.EShop.Photos", b =>
                {
                    b.HasOne("Core.Models.EShop.Product", "Product")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("Core.Models.EShop.Product", b =>
                {
                    b.HasOne("Core.Models.EShop.Subcategory", "Subcategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductElement", b =>
                {
                    ...
                    b.HasOne("Core.Models.EShop.ProductType", "ProductType")
                        .WithMany("ProductElements")
                        .HasForeignKey("ProductTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.EShop.ProductValue", "ProductValue")
                        .WithMany("ProductElements")
            ...
            modelBuilder.Entity("Core.Models.EShop.ProductRefHistory", b =>
                {
                    b.HasOne("Core.Models.EShop.History", "History")
            ...
            modelBuilder.Entity("Core.Models.EShop.Subcategory", b =>
                {
                    b.HasOne("Core.Models.EShop.Category", "Category")
